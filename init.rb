...
Redmine::Plugin.register :redmine_time_tracker do
  ...
  settings :default => {:report_title => 'Report', :report_logo_url => '', :report_logo_width => '150', :round_steps => '0.25', :round_limit => '50', :round_default => false, :booking_no_issue_comments=>false}, :partial => 'settings/time_tracker'
